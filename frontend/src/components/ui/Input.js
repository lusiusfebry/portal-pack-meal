...
export function Input({ label, error, helperText, leftIcon, rightIcon, className, disabled, ...props }) {
    ...
    return (_jsxs("div", { children: [label ? (_jsx("label", { htmlFor: inputId, className: "block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5", children: label })) : null, _jsxs("div", { className: "relative", children: [leftIcon ? (_jsx("span", { className: "pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-400", children: leftIcon })) : null, _jsx("input", { id: inputId, className: computedInputClassName, "aria-invalid": Boolean(error), "aria-describedby": describedByIds.length ? describedByIds.join(' ') : undefined, disabled: disabled, ...props }), rightIcon ? (_jsx("span", { className: "pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-400", children: rightIcon })) : null] }), error ? (_jsx("p", { id: errorId, className: "mt-1.5 text-sm text-red-600 dark:text-red-400", role: "alert", children: error })) : helperText ? (_jsx("p", { id: helperId, className: "mt-1.5 text-sm text-slate-500 dark:text-slate-400", children: helperText })) : null] }));
}
