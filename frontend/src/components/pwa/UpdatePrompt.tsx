...
export default function UpdatePrompt(): JSX.Element | null {
  ...
  const containerClasses =
    'fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-1rem)] sm:w-[400px]';
  const cardClasses = [
    'relative',
  ...
  return (
    <div className={containerClasses} role="dialog" aria-label="Pemberitahuan update tersedia">
      <Card className={cardClasses} padding="md" hover={false}>
        ...
        <div className="flex items-start gap-4">
          <div className="mt-1">
            <ArrowPathIcon className="h-8 w-8 text-emerald-500" aria-hidden="true" />
          </div>
