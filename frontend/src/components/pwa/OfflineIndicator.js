...
export default function OfflineIndicator() {
    ...
    return (_jsx("div", { className: containerClasses, role: "status", "aria-live": "polite", "aria-label": isOnline ? 'Online' : 'Offline', children: _jsxs("div", { className: "flex items-center gap-2 px-4 py-2 bg-amber-500 text-white rounded-full shadow-lg animate-pulse", children: [_jsx(SignalSlashIcon, { className: "h-5 w-5", "aria-hidden": "true" }), _jsx("span", { className: "text-sm font-medium", children: "Offline" })] }) }));
}
