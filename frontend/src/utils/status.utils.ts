...
import { StatusPesanan, type OrderStatus } from '@/types/order.types';
...
/**
 * Variant Badge yang tersedia pada komponen Badge.
 ...
 */
export function isAwaitingApproval(status: OrderStatus): boolean {
 ...
 */
export function getAllowedTransitionsByRole(
  role: Role,
  current: OrderStatus,
): OrderStatus[] {
